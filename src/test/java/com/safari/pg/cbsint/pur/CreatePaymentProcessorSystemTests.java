...
@AutoConfigureWebMvc
public class CreatePaymentProcessorSystemTests {
	@Autowired
	...
	public void createMerchantOrderVendorResponse() throws CbsInterfaceException {
		...
		int result = this.chInterface.createPaymentProcessorSystem(createdByUserId, systemName, desc, systemUrl, systemSecret, protocolId, stystemUsername, systemPassword, isActive, myIp, myPartnerId);
