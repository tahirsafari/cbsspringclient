...
@AutoConfigureWebMvc
public class CreateProductServiceProfileTests {
	@Autowired
	...
	public void createProductServiceProfile() throws Exception {
		...
		int  result = chInterface.createProductServiceProfile(createdByUserId, productId, serviceId, serviceProfileDesc, serviceChargeModeId, maxOutTxAmount, minOutTxAmount, maxInTxAmount, minInTxAmount, dailyInTxLimit, dailyOutTxLimit, monthlyInTxLimit, monthlyOutTxLimit);
		System.out.println("result "+result);
		assertTrue(result > 0);
	}
	
//	@Test(expected=CbsInterfaceException.class)
//	public void createProductServiceProfile_ThrowsException() throws Exception {
//		int createdByUserId = 1;
//		int serviceId = 2;
//		int productId = 1;
